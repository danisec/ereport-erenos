<x-app-layout title="{{ $title }}">
    ...
    <section class="layout min-h-screen bg-hero py-6 font-rubik">
        <div class="w-full rounded-2xl bg-white py-5 shadow-sm">
            ...
            <form class="flex flex-col gap-3 px-11 pt-9" action="{{ route('guru.store') }}" method="post">
                @csrf

                <div class="flex flex-col gap-1">
                    <div class="flex flex-row items-center">
                        <label class="mb-2 w-64 text-xl font-medium leading-9">Nomor Guru</label>
                        <input class="field-input-indigo w-52" name="NIP" type="number" value="{{ old('NIP') }}"
                ...
                <div class="flex flex-col gap-1">
                    <div class="flex flex-row items-center gap-16">
                        ...
                        <input class="field-input-indigo w-8/12" name="namaGuru" type="text"
