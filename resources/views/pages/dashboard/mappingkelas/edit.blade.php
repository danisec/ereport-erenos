    ...
    <section class="layout min-h-screen bg-hero py-6 font-rubik">
        <div class="w-full rounded-2xl bg-white py-5 shadow-sm">
            ...
            <div class="w-6/12 rounded-r-2xl bg-hero py-2">
                <h4 class="text-gray-9000 px-11 text-2xl font-bold text-white">Ubah Mapping Kelas Siswa</h4>
            </div>

            <form class="flex flex-col gap-6 px-11 pt-9" action="/dashboard/mappingkelas/{{ $mappingkelas->idMapping }}"
                method="post">
                @method('put')
                @csrf
                        ...
                        <div class="flex flex-col gap-1">
                            <div class="flex flex-row items-center">
                                ...
                                <select class="field-input-indigo w-52" name="idKelas" required>
                                    <option value="{{ $mappingkelas->idKelas }}" selected hidden>
                                        {{ $mappingkelas->kelas->kelas }}
                                    </option>
                        ...
                        <div class="flex flex-col gap-1">
                            <div class="flex flex-row items-center">
                                ...
                                <select class="field-input-indigo w-64" name="NIP" required>
                                    <option value="{{ $mappingkelas->NIP }}" selected hidden>
                                        {{ $mappingkelas->guru->namaGuru }}</option>
