<x-layouts.app-layout title="{{ $title }}">
    ...
    <section class="layout min-h-screen bg-hero py-6 font-rubik">
        <div class="w-full rounded-2xl bg-white py-5 shadow-sm">
            ...
            <form class="flex flex-col gap-3 px-11 pt-9" action="/dashboard/siswa/{{ $siswa->NIS }}" method="post">
                @method('put')
                @csrf
                ...
                <div class="flex flex-col gap-1">
                    <div class="flex flex-row items-center">
                        ...
                        <input class="@error('NIS') border-red-300 bg-red-300 @enderror field-input-indigo w-52"
                ...
                <div class="flex flex-col gap-1">
                    <div class="flex flex-row items-center gap-16">
                        ...
                        <input class="@error('nmSiswa') border-red-300 bg-red-300 @enderror field-input-indigo w-8/12"
                ...
                <div class="flex flex-col gap-1">
                    <div class="flex flex-row items-center gap-16">
                        ...
                        <input class="@error('nmPanggil') border-red-300 bg-red-300 @enderror field-input-indigo w-96"
