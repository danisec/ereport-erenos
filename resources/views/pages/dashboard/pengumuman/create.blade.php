    ...
    <section class="layout min-h-screen bg-hero py-6 font-rubik">
        <div class="w-full rounded-2xl bg-white py-5 shadow-sm">
            ...
            <div class="w-6/12 rounded-r-2xl bg-hero py-2">
                <h4 class="text-gray-9000 px-11 text-2xl font-bold text-white">Menambah Data Pengumuman</h4>
            </div>

            <form class="flex flex-col gap-3 px-11 pt-9" action="{{ route('pengumuman.store') }}" method="post">
                @csrf
                ...
                <div class="flex flex-col">
                    <div class="flex flex-row items-center">
                        ...
                        <input class="field-input-indigo w-64" id="datetime" name="tanggal" type="datetime-local"
                            required />
                    </div>
                ...
                <div class="flex flex-col">
                    <div class="flex flex-row items-center">
                        ...
                        <input class="field-input-indigo w-8/12" name="namaPengumuman" type="text"
                            value="{{ old('namaPengumuman') }}" placeholder="Nama" required>
                    </div>
                ...
                <div class="flex flex-col">
                    <div class="flex flex-row items-start">
                        ...
                        <textarea class="field-input-indigo hidden w-96" name="pengumuman" placeholder="Pengumuman">{{ old('pengumuman') }}</textarea>
                    </div>
