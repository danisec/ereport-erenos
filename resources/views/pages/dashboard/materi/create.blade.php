    ...
    <section class="layout min-h-screen bg-hero py-6 font-rubik">
        <div class="w-full rounded-2xl bg-white py-5 shadow-sm">
            ...
            <div class="w-6/12 rounded-r-2xl bg-hero py-2">
                <h4 class="text-gray-9000 px-11 text-2xl font-bold text-white">Menambah Data Materi</h4>
            </div>

            <form class="flex flex-col gap-3 px-11 pt-9" action="{{ route('materi.store') }}" method="post">
                @csrf
                    ...
                    <table class="w-full text-left" id="table">
                        ...
                        <tbody>
                            <tr class="bg-white text-base font-medium leading-5 hover:bg-gray-50">
                                ...
                                <td class="pl-3">
                                    <textarea class="field-input-indigo materi-input text-md w-[55rem] font-normal" name="materi[]" rows="1"
                                        placeholder="Materi" required></textarea>
                                </td>
                                <td class="w-10 text-center">
                                    <button class="delete-materi-btn focus:outline-none" type="button">
                                        <x-atoms.trash :alt="'hapus-materi'" />
                                    </button>
                                </td>
                            </tr>
                        </tbody>
