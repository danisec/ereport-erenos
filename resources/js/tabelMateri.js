...
$("#add").click(function () {
    ...
    $("#table").append(
        `<tr>
                ...
                <td class="pl-3">
                    <textarea class="field-input-indigo materi-input w-[55rem]" name="materi[]" rows="1" placeholder="Materi" required></textarea>
                </td>
...
$(document).on("click", ".delete-materi-btn", function () {
